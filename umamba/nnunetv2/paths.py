...
nnUNet_raw = "/content/drive/MyDrive/ARCADE/data/arcade_challenge_datasets/mamba_data_format/nnUNet_raw" #join(base, 'nnUNet_raw') # os.environ.get('nnUNet_raw')
nnUNet_preprocessed = "/content/drive/MyDrive/ARCADE/data/arcade_challenge_datasets/mamba_data_format/nnUNet_preprocessed" #join(base, 'nnUNet_preprocessed') # os.environ.get('nnUNet_preprocessed')
nnUNet_results = "/content/drive/MyDrive/ARCADE/data/arcade_challenge_datasets/mamba_data_format/nnUNet_results" #join(base, 'nnUNet_results') # os.environ.get('nnUNet_results')
